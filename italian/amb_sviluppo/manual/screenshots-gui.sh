...
"${ETHOS}/X20S/simulator.exe"   --read-only --no-audio --radio-settings ./x20s-it.bin   --sd-directory ./sd --flash-directory ./flash --exec ./macros/model-edit.lua

"${ETHOS}/X20S/simulator.exe"   --read-only --no-audio --radio-settings ./x20s-it.bin   --sd-directory ./sd --flash-directory ./flash --exec ./macros/model-fm.lua

"${ETHOS}/X20S/simulator.exe"   --read-only --no-audio --radio-settings ./x20s-it.bin   --sd-directory ./sd --flash-directory ./flash --exec ./macros/model-mixes.lua

"${ETHOS}/X20S/simulator.exe"   --read-only --no-audio --radio-settings ./x20s-it.bin   --sd-directory ./sd --flash-directory ./flash --exec ./macros/model-mixes-free.lua
...
"${ETHOS}/X20S/simulator.exe"   --read-only --no-audio --radio-settings ./x20s-it.bin   --sd-directory ./sd --flash-directory ./flash --exec ./macros/model-trims.lua
