...
simulator.screenshot("/screenshots/model-vars.png")
...
simulator.screenshot("/screenshots/model-vars-add-action.png")
simulator.pressKey(KEY_ENTER) -- y
...
simulator.screenshot("/screenshots/model-vars-functions.png")
simulator.turnRotaryEncoder(7) -- scroll to repurpose
simulator.screenshot("/screenshots/model-vars-functions-repurpose-select.png")
simulator.pressKey(KEY_ENTER) -- y
...
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/model-vars-calc-example.png")
simulator.pressKey(KEY_RTN)
