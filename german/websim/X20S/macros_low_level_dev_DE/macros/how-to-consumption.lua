...
simulator.screenshot("/screenshots/how-to-consumption-create-calc-select.png")
...
simulator.screenshot("/screenshots/how-to-consumption-sensor-edit.png")
...
simulator.pressKey(KEY_ENTER) --y
simulator.screenshot("/screenshots/how-to-consumption-sensor-edit2.png")
...
simulator.pressKey(KEY_RTN) --exit 
--
simulator.screenshot("/screenshots/how-to-consumption-lsw-delta200mAh.png")
...
simulator.turnRotaryEncoder(6) -- skip new priority
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(1)
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(1)
...
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/how-to-consumption-sf-play-value-consumption.png")
simulator.pressKey(KEY_RTN, 1)
--
...
simulator.pressKey(KEY_RTN) --exit
simulator.screenshot("/screenshots/how-to-consumption-lsw2-play-battlow.png")
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
...
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/how-to-consumption-sf2-play-value-consumption.png")
simulator.pressKey(KEY_RTN, 1)
