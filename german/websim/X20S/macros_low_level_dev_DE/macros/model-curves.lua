...
simulator.turnRotaryEncoder(1) --scroll to x<0
simulator.pressKey(KEY_ENTER) -- open
simulator.screenshot("/screenshots/model-curves-fn-xlt0.png")
simulator.pressKey(KEY_ENTER) -- open fn list
simulator.turnRotaryEncoder(1) --scroll to |x|
simulator.pressKey(KEY_ENTER) -- open
simulator.screenshot("/screenshots/model-curves-fn-barx.png")
simulator.pressKey(KEY_ENTER) -- open fn list
simulator.turnRotaryEncoder(1) --scroll to f>0
simulator.pressKey(KEY_ENTER) -- open
simulator.screenshot("/screenshots/model-curves-fn-fgt0.png")
simulator.pressKey(KEY_ENTER) -- open fn list
simulator.turnRotaryEncoder(1) --scroll to f<0
simulator.pressKey(KEY_ENTER) -- open
simulator.screenshot("/screenshots/model-curves-fn-flt0.png")
simulator.pressKey(KEY_ENTER) -- open fn list
simulator.turnRotaryEncoder(1) --scroll to |f|
simulator.pressKey(KEY_ENTER) -- open
simulator.screenshot("/screenshots/model-curves-fn-barf.png")
simulator.pressKey(KEY_ENTER) -- open fn list
...
-- simulator.screenshot("/screenshots/model-curves-custom5.png")
...
simulator.pressKey(KEY_ENTER) -- edit
simulator.turnRotaryEncoder(5) -- scroll to curve type
simulator.screenshot("/screenshots/model-curves-custom5.png")
simulator.turnRotaryEncoder(5) -- scroll to point 1 y value
...
simulator.pressKey(KEY_RTN) -- back to points list
simulator.screenshot("/screenshots/model-curves-custom5-2.png")
...
simulator.turnRotaryEncoder(-8) -- back to smooth
simulator.pressKey(KEY_ENTER) -- enable smooth
simulator.screenshot("/screenshots/model-curves-custom5-2-smooth.png")
...
simulator.turnRotaryEncoder(1) -- scroll to edit
simulator.screenshot("/screenshots/model-curves-edit-options.png")
simulator.pressKey(KEY_ENTER) -- edit cv1
simulator.screenshot("/screenshots/model-curves-expo.png")
simulator.pressKey(KEY_RTN) -- back to curves list
...
simulator.turnRotaryEncoder(17) -- scroll page
simulator.turnRotaryEncoder(-5) -- scroll back to point 2
simulator.screenshot("/screenshots/model-curves-custom-easy-off.png")
...
simulator.screenshot("/screenshots/model-curves-fn-offset-var.png")
simulator.pressKey(KEY_RTN) -- deselect
simulator.pressKey(KEY_RTN) -- back to curves list 
...
simulator.turnRotaryEncoder(14) -- scroll page
simulator.turnRotaryEncoder(-2) -- scroll back up
simulator.screenshot("/screenshots/model-curves-custom-with-var.png")
simulator.pressKey(KEY_RTN) -- deselect
simulator.pressKey(KEY_RTN) -- back to curves list
simulator.pressKey(KEY_RTN) -- deselect
