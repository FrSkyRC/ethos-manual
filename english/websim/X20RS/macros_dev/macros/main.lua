...
--2025-10-22 convert to web sim (main.lua)
...
--simulator.screenshot("/screenshots/system-hardware-bt-audio.png")
simulator.pressKey(KEY_ENTER) -- open options
simulator.screenshot("/screenshots/system-hardware-bt-audio-options.png")
