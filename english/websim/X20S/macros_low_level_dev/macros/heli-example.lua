...
simulator.screenshot("/screenshots/tut-heli-eg-wiz-create-heli.png")
simulator.pressKey(KEY_ENTER)
--simulator.screenshot("/screenshots/tut-heli-eg-wiz-create-heli.png")
--simulator.pressKey(KEY_PAGE) -- go to next page
simulator.screenshot("/screenshots/tut-heli-eg-wiz-fbl.png")
simulator.pressKey(KEY_PAGE)
simulator.screenshot("/screenshots/tut-heli-eg-wiz-ch-reassign.png")
simulator.pressKey(KEY_PAGE) -- go to next page
...
simulator.screenshot("/screenshots/tut-heli-eg-wiz-name.png")
simulator.pressKey(KEY_PAGE) -- complete model creation
--
-- review mixes
simulator.pressKey(KEY_MDL) -- open model menu
simulator.turnRotaryEncoder(4) -- scroll to mixes
simulator.screenshot("/screenshots/tut-heli-eg-mixes-icon.png")
simulator.pressKey(KEY_ENTER) -- open mixes
simulator.screenshot("/screenshots/tut-heli-eg-mixes.png")
simulator.turnRotaryEncoder(1) -- scroll to ail mix
simulator.screenshot("/screenshots/tut-heli-eg-mixes-ail.png")
--
...
--simulator.screenshot("/screenshots/tut-heli-eg-mixes-icon.png")
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-heli-eg-mixes-final.png")
simulator.turnRotaryEncoder(5) -- scroll to pitch
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(1) -- scroll to edit
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-heli-eg-mixes-pitch.png")
simulator.pressKey(KEY_RTN) -- back to mixes list
simulator.turnRotaryEncoder(1) -- scroll to bank mix
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(1) -- scroll to edit
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-heli-eg-mixes-bank.png")
simulator.pressKey(KEY_RTN) -- back to mixes list
simulator.turnRotaryEncoder(1) -- scroll to gain mix
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(1) -- scroll to edit
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-heli-eg-mixes-gyro-gain.png")
simulator.pressKey(KEY_RTN) -- back to mixes list
simulator.pressKey(KEY_RTN) -- deselect mix
--simulator.pressKey(KEY_RTN) -- 2025-10-11 remove one too many RTN due to bug
...
simulator.screenshot("/screenshots/tut-heli-eg-flight-modes.png")
...
simulator.screenshot("/screenshots/tut-heli-eg-mixes-thr-cut.png")
simulator.turnRotaryEncoder(17) -- scroll to end of thr mix
simulator.screenshot("/screenshots/tut-heli-eg-mixes-thr-curves.png")
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
