...
simulator.pressKey(KEY_ENTER) --y
--
simulator.screenshot("/screenshots/how-to-low-batt-lsw-battlow-lipo.png")
simulator.pressKey(KEY_ENTER, 0.6) --long ENT
simulator.turnRotaryEncoder(3) -- scroll to lowest
simulator.pressKey(KEY_ENTER) --y
simulator.screenshot("/screenshots/how-to-low-batt-lsw-battlow-lipo-select-lowest.png")
...
simulator.screenshot("/screenshots/how-to-low-batt-lsw-summary.png")
simulator.pressKey(KEY_RTN) --deselect cursor
...
simulator.pressKey(KEY_ENTER) --y
--
simulator.screenshot("/screenshots/how-to-low-batt-sf-play-value-lipo.png")
simulator.pressKey(KEY_RTN) -- deselect
simulator.pressKey(KEY_RTN) -- back to sf
simulator.screenshot("/screenshots/how-to-low-batt-sf-play-value-lipo-summary.png")
