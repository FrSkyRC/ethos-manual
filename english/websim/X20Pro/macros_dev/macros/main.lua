...
simulator.touch(400, 269) -- add new sf button '+'
...
simulator.touch(395, 401) -- V
simulator.touch(398, 450) -- space
simulator.touch(317, 352) -- F
simulator.touch(402, 453) -- space
simulator.touch(277, 302) -- R
simulator.touch(400, 454) -- space
