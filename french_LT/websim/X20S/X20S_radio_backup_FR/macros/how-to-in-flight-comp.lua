...
simulator.screenshot("/screenshots/how-in-flight-comp-lsws.png")
simulator.pressKey(KEY_ENTER) --open dialog
simulator.turnRotaryEncoder(1) --scroll to edit
simulator.pressKey(KEY_ENTER) --y
simulator.screenshot("/screenshots/how-in-flight-comp-lsw-adaptivept2.png")
simulator.pressKey(KEY_RTN) --exit
simulator.turnRotaryEncoder(1) --scroll to next lsw
simulator.pressKey(KEY_ENTER) --open dialog
simulator.turnRotaryEncoder(1) --scroll to edit
simulator.pressKey(KEY_ENTER) --y
simulator.screenshot("/screenshots/how-in-flight-comp-lsw-adaptivept3.png")
simulator.pressKey(KEY_RTN) --exit
simulator.turnRotaryEncoder(1) --scroll to next lsw
simulator.pressKey(KEY_ENTER) --open dialog
simulator.turnRotaryEncoder(1) --scroll to edit
simulator.pressKey(KEY_ENTER) --y
simulator.screenshot("/screenshots/how-in-flight-comp-lsw-adaptivept4.png")
simulator.pressKey(KEY_RTN) --exit
simulator.turnRotaryEncoder(1) --scroll to next lsw
simulator.pressKey(KEY_ENTER) --open dialog
simulator.turnRotaryEncoder(1) --scroll to edit
simulator.pressKey(KEY_ENTER) --y
simulator.screenshot("/screenshots/how-in-flight-comp-lsw-adaptivept5.png")
simulator.pressKey(KEY_RTN) --exit
...
simulator.screenshot("/screenshots/how-in-flight-comp-vars.png")
simulator.pressKey(KEY_ENTER) --y
simulator.turnRotaryEncoder(1) --scroll to edit
simulator.pressKey(KEY_ENTER) --y
simulator.turnRotaryEncoder(1)
simulator.screenshot("/screenshots/how-in-flight-comp-var-vadjpt2.png")
simulator.turnRotaryEncoder(6) --scroll to actions line
simulator.screenshot("/screenshots/how-in-flight-comp-var-vadjpt2-2.png")
simulator.pressKey(KEY_RTN) --exit
...
simulator.screenshot("/screenshots/how-in-flight-comp-var-vadjpt3.png")
simulator.turnRotaryEncoder(6)
simulator.screenshot("/screenshots/how-in-flight-comp-var-vadjpt3-2.png")
simulator.pressKey(KEY_RTN) --exit
simulator.pressKey(KEY_RTN) --back to var list
simulator.turnRotaryEncoder(1) --scroll to next var
simulator.pressKey(KEY_ENTER) --open dialog
...
--simulator.pressKey(KEY_ENTER)
--simulator.pressKey(KEY_RTN) --deselect so sim does not edit here
simulator.screenshot("/screenshots/how-in-flight-comp-var-vadjpt4.png")
simulator.turnRotaryEncoder(6)
simulator.screenshot("/screenshots/how-in-flight-comp-var-vadjpt4-2.png")
simulator.pressKey(KEY_RTN) --exit
simulator.pressKey(KEY_RTN) --back to var list
simulator.turnRotaryEncoder(1) --scroll to next var
simulator.pressKey(KEY_ENTER) --open dialog
...
--simulator.pressKey(KEY_ENTER)
--simulator.pressKey(KEY_RTN) --deselect so sim does not edit here
simulator.screenshot("/screenshots/how-in-flight-comp-var-vadjpt5.png")
simulator.turnRotaryEncoder(6) --scroll to actions line
simulator.screenshot("/screenshots/how-in-flight-comp-var-vadjpt5-2.png")
