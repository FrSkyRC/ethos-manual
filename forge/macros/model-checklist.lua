...
simulator.screenshot("/screenshots/model-checklist-at_start.png")
...
simulator.screenshot("/screenshots/model-icon-checklist.png")
simulator.pressKey(KEY_ENTER) -- open checklist
simulator.turnRotaryEncoder(1) -- scroll to thr
simulator.screenshot("/screenshots/model-checklist.png")
...
simulator.screenshot("/screenshots/model-checklist-check_function.png")
...
simulator.screenshot("/screenshots/model-checklist-switches.png")
simulator.pressKey(KEY_ENTER) -- open sw options
simulator.screenshot("/screenshots/model-checklist-switches-options.png")
simulator.pressKey(KEY_RTN) -- exit options
...
simulator.screenshot("/screenshots/model-checklist-function-switches.png")
simulator.pressKey(KEY_ENTER) -- open fs1 options
simulator.screenshot("/screenshots/model-checklist-function-switches-options.png")
...
simulator.screenshot("/screenshots/model-checklist-pots.png")
simulator.turnRotaryEncoder(-1) -- scroll back to s1 function
simulator.pressKey(KEY_ENTER) -- open pots options
simulator.screenshot("/screenshots/model-checklist-pots-options.png")
simulator.pressKey(KEY_RTN) -- exit options
