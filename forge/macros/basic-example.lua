...
simulator.screenshot("/screenshots/tut-fw-eg-create-model.png")
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-fw-eg-wiz-create-airplane.png")
simulator.pressKey(KEY_PAGE)
simulator.screenshot("/screenshots/tut-fw-eg-wiz-rx.png")
simulator.pressKey(KEY_PAGE)
simulator.screenshot("/screenshots/tut-fw-eg-wiz-engine.png")
simulator.pressKey(KEY_PAGE)
simulator.turnRotaryEncoder(2) --scroll to flaps
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(2) --select 2 flaps
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-fw-eg-wiz-ail-flaps.png")
simulator.pressKey(KEY_PAGE)
simulator.screenshot("/screenshots/tut-fw-eg-wiz-tail.png")
simulator.pressKey(KEY_PAGE)
simulator.screenshot("/screenshots/tut-fw-eg-wiz-ele-rudd.png")
simulator.pressKey(KEY_PAGE)
simulator.screenshot("/screenshots/tut-fw-eg-wiz-ch-reassign.png")
simulator.pressKey(KEY_PAGE)
...
simulator.setSwitch(1, 0) -- set switch SB mid as rates switch
simulator.pressKey(KEY_MDL) --open model menu
simulator.turnRotaryEncoder(4) --scroll to mixes
simulator.screenshot("/screenshots/tut-fw-eg-mixes-icon.png")
simulator.pressKey(KEY_ENTER) --y
simulator.screenshot("/screenshots/tut-fw-eg-mixes.png")
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ail-edit.png")
simulator.pressKey(KEY_ENTER) --y
simulator.turnRotaryEncoder(1) -- scroll cursor to ail mix
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ail-mix.png")
--
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ail-weight-rates.png")
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ail-expo-rates.png")
--end of ele mix review, start of diff
--simulator.setSwitch(1, 0) -- set switch SB off as rates switch
simulator.setSwitch(1, -100) -- set switch SB off as rates switch
...
simulator.pressKey(KEY_ENTER) -- y
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ail-diff-50.png")
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ail-diff-use-pot1.png")
simulator.pressKey(KEY_ENTER, 0.6) --long ENT
simulator.turnRotaryEncoder(3) --scroll to convert to value
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ail-diff-convert-to-value.png")
simulator.pressKey(KEY_ENTER) -- y
simulator.pressKey(KEY_ENTER) -- edit
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ail-trim.png")
...
simulator.pressKey(KEY_ENTER) --y
--
-- simulator.screenshot("/screenshots/tut-fw-eg-mixes-ele-weight-rates.png")
--
simulator.turnRotaryEncoder(1) -- scroll to add curve
simulator.pressKey(KEY_ENTER) --y
...
simulator.pressKey(KEY_ENTER) -- y
--
simulator.screenshot("/screenshots/tut-fw-eg-mixes-ele-expo-rates.png")
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-thr-edit.png")
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-thr-low-pos-trim.png")
...
--simulator.screenshot("/screenshots/tut-fw-eg-mixes-thr-cut.png")
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-thr-hold.png")
simulator.turnRotaryEncoder(7) --scroll screen up
simulator.pressKey(KEY_ENTER)
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/tut-fw-eg-mixes-thr-ch3.png")
simulator.pressKey(KEY_RTN, 1)
...
simulator.pressKey(KEY_ENTER) --y
-- end select sw SE
simulator.screenshot("/screenshots/tut-fw-eg-mixes-flaps-input.png")
...
simulator.pressKey(KEY_ENTER) --y
simulator.turnRotaryEncoder(1)
simulator.screenshot("/screenshots/tut-fw-eg-mixes-flaps-weights.png")
simulator.pressKey(KEY_RTN, 1)
...
simulator.screenshot("/screenshots/tut-fw-eg-outputs.png")
simulator.pressKey(KEY_ENTER) --y
simulator.turnRotaryEncoder(6) --scroll to curve
simulator.screenshot("/screenshots/tut-fw-eg-outputs-edit-ail.png")
simulator.pressKey(KEY_RTN, 1)
...
simulator.screenshot("/screenshots/tut-fw-eg-mixes-library.png")
...
simulator.pressKey(KEY_ENTER) --y
-- end of select sw SF
simulator.screenshot("/screenshots/tut-fw-eg-retracts-source.png")
