...
simulator.screenshot("/screenshots/model-mixes-chview-elevator.png")
simulator.pressKey(KEY_ENTER) -- open mix
simulator.turnRotaryEncoder(2) -- scroll to channel view
simulator.screenshot("/screenshots/model-mixes-chview-select.png")
simulator.pressKey(KEY_ENTER) -- enable
simulator.sleep(3) -- wait 
simulator.screenshot("/screenshots/model-mixes-chview-elevator-channel-view.png")
simulator.turnRotaryEncoder(-1) -- scroll back to ch ele parent
simulator.screenshot("/screenshots/model-mixes-chview-elevator-channel.png")
simulator.pressKey(KEY_ENTER) -- toggle to ch ele parent collapsed
simulator.screenshot("/screenshots/model-mixes-chview-collapsed.png")
...
simulator.screenshot("/screenshots/model-mixes-chview-table-view-select.png")
simulator.pressKey(KEY_ENTER) -- enable table view
simulator.screenshot("/screenshots/model-mixes-chview-back-at-mixes-view.png")
