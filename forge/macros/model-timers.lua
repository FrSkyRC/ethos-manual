...
simulator.screenshot("/screenshots/model-icon-timers.png")
simulator.pressKey(KEY_ENTER) -- open
-- simulator.setSwitch(0, 1) -- set switch A to mid for thr active
simulator.screenshot("/screenshots/model-timers.png")
simulator.turnRotaryEncoder(1) -- scroll to timer 1
simulator.pressKey(KEY_ENTER) -- open options
simulator.screenshot("/screenshots/model-timers-action-select.png")
...
simulator.screenshot("/screenshots/model-timer1-edit.png")
...
simulator.pressKey(KEY_RTN) -- back to stop cond
simulator.screenshot("/screenshots/model-timer1-edit-stop.png") -- stop condition
simulator.turnRotaryEncoder(5) -- scroll to add action
simulator.screenshot("/screenshots/model-timer1-add-action.png") -- add audio action

simulator.pressKey(KEY_ENTER) -- add action
simulator.screenshot("/screenshots/model-timer1-action-countdown.png") -- add audio action
...
simulator.pressKey(KEY_ENTER) -- open
simulator.screenshot("/screenshots/model-timer1-action-type-select.png") -- add audio action
...
simulator.turnRotaryEncoder(translate("Timer1FilePosition", 228)) -- scroll to timer-1-elapsed.wav
...
simulator.turnRotaryEncoder(-3) -- scroll back to name
simulator.screenshot("/screenshots/model-timer2-edit.png")
...
simulator.turnRotaryEncoder(translate("Timer2FilePosition", 231)) -- scroll to timer-2-elapsed.wav
--simulator.turnRotaryEncoder(-10)
...
simulator.screenshot("/screenshots/model-timer2-actions-summary.png")
simulator.pressKey(KEY_RTN, 1) -- return home
-- debug - show output page
--simulator.pressKey(KEY_MDL) -- open model menu
--simulator.turnRotaryEncoder(5) -- scroll to channels
--simulator.pressKey(KEY_ENTER) -- open
--simulator.sleep(5) -- delay to view page
--simulator.pressKey(KEY_RTN, 1) -- return home
