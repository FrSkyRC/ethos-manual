...
simulator.screenshot("/screenshots/how-to-butterfly-flaps-disable.png")
...
simulator.screenshot("/screenshots/how-to-butterfly-mix-added.png")
...
simulator.pressKey(KEY_ENTER)
--
simulator.screenshot("/screenshots/how-to-butterfly-mix-source-thr.png")
simulator.pressKey(KEY_ENTER, 0.6) -- long ENT
simulator.turnRotaryEncoder(3) --scroll to invert (new positive is position 1)
simulator.pressKey(KEY_ENTER) --y
simulator.screenshot("/screenshots/how-to-butterfly-mix-source-thr-neg-select.png")
simulator.pressKey(KEY_RTN) -- close dialog
simulator.screenshot("/screenshots/how-to-butterfly-mix-source-thr-neg.png")
simulator.turnRotaryEncoder(1) -- scroll to curve param
simulator.screenshot("/screenshots/how-to-butterfly-mix-curve-select.png")
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(3) -- scroll to custom
--simulator.screenshot("/screenshots/how-to-butterfly-mix-curve-add.png")
simulator.pressKey(KEY_ENTER)
...
simulator.screenshot("/screenshots/how-to-butterfly-mix-curve-3pt-points.png")
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN) -- back to bfly mix
simulator.screenshot("/screenshots/how-to-butterfly-mix-curve-added.png")
...
simulator.pressKey(KEY_RTN)
simulator.turnRotaryEncoder(1)
simulator.screenshot("/screenshots/how-to-butterfly-mix-ailerons.png")
...
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN) --
simulator.screenshot("/screenshots/how-to-butterfly-offset-mix-80.png")
...
simulator.pressKey(KEY_RTN) -- deselect
simulator.turnRotaryEncoder(1)
simulator.screenshot("/screenshots/how-to-butterfly-comp-curve-points.png")
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
...
simulator.screenshot("/screenshots/how-to-butterfly-comp-mix.png")
...
simulator.pressKey(KEY_ENTER)
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/how-to-butterfly-comp-mix-ch20.png")
simulator.pressKey(KEY_RTN, 1)
--
...
simulator.screenshot("/screenshots/how-to-butterfly-mix-ele-comp.png")
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
...
simulator.turnRotaryEncoder(5) 
simulator.screenshot("/screenshots/how-to-butterfly-mix-ele-comp-view-per-ch.png")
simulator.pressKey(KEY_RTN, 1)
