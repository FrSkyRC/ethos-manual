...
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/model-mix-eg-using-weight.png")
...
simulator.pressKey(KEY_ENTER)
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/model-mix-eg-using-offset-actions.png")
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/model-mix-eg-using-offset.png")
-- simulator.pressKey(KEY_ENTER)
-- simulator.turnRotaryEncoder(1)
-- simulator.pressKey(KEY_ENTER)
-- simulator.screenshot("/screenshots/model-mix-eg-using-offset-actions.png")
