...
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-wing-eg-wiz-create-airplane.png")
simulator.turnRotaryEncoder(1) -- hightlight airplane
simulator.pressKey(KEY_PAGE) -- accept airplane and jumpto next page
simulator.screenshot("/screenshots/tut-wing-eg-wiz-rx.png")
...
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-wing-eg-wiz-no-engine.png")
simulator.pressKey(KEY_PAGE) --to next page
simulator.screenshot("/screenshots/tut-wing-eg-wiz-ail-flaps.png")
simulator.pressKey(KEY_PAGE) --to next page
simulator.turnRotaryEncoder(1) -- scroll to tail
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(-1) -- scroll to no tail
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/tut-wing-eg-wiz-no-tail.png")
simulator.pressKey(KEY_PAGE) --to next page
simulator.screenshot("/screenshots/tut-wing-eg-wiz-ch-reassign.png")
simulator.pressKey(KEY_PAGE) --to next page
...
simulator.screenshot("/screenshots/tut-wing-eg-wiz-name.png")
simulator.pressKey(KEY_PAGE) --to next page
simulator.pressKey(KEY_MDL) -- open model menu
simulator.turnRotaryEncoder(4) -- scroll to mixes
simulator.screenshot("/screenshots/tut-wing-eg-mixes-icon.png")
simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(1)
simulator.screenshot("/screenshots/tut-wing-eg-mixes.png")
--
...
simulator.screenshot("/screenshots/tut-wing-eg-mixes-ail-mix-weight.png")
...
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/tut-wing-eg-mixes-ail-mix.png")
...
simulator.screenshot("/screenshots/tut-wing-eg-mixes-ail-diff-04.png")
simulator.pressKey(KEY_RTN)
...
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/tut-wing-eg-mixes-ele-mix.png")
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN) -- back to mixes list
--
-- start of rudder mix
...
simulator.screenshot("/screenshots/tut-wing-eg-mixes-rud-mix.png")
...
simulator.setAnalog(elevatorStickIndex, 0) -- set ele to 0%
simulator.sleep(1) -- wait 
--simulator.pressKey(KEY_RTN) --exit mixes
--simulator.pressKey(KEY_RTN)
--simulator.pressKey(KEY_RTN)
...
simulator.setAnalog(elevatorStickIndex, 100) -- set ele to 100%
simulator.sleep(1) -- wait 
