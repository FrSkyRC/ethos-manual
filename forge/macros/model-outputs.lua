...
simulator.screenshot("/screenshots/model-outputs-sbus-warning.png")
...
simulator.screenshot("/screenshots/model-outputs-swap-channels-select.png")
...
--
simulator.screenshot("/screenshots/model-outputs-swap-channels.png")
simulator.touch(544, 319)
simulator.turnRotaryEncoder(1)
simulator.screenshot("/screenshots/model-outputs-reset-select.png")
...
simulator.screenshot("/screenshots/model-outputs-balance-select.png")
simulator.pressKey(KEY_ENTER)
simulator.screenshot("/screenshots/model-outputs-balance-choose_channels.png")
--simulator.screenshot("./screenshot4.png")
--simulator.pressKey(KEY_ENTER)
simulator.turnRotaryEncoder(7) -- scroll to flap R ch7
simulator.pressKey(KEY_ENTER) -- select
simulator.pressKey(KEY_PAGE) -- page to ok button
simulator.screenshot("/screenshots/model-outputs-balance-choose-ch7-and-ch6.png")
simulator.pressKey(KEY_ENTER) -- confirm channels
simulator.screenshot("/screenshots/model-outputs-balance-ch7-and-ch6.png")
...
simulator.screenshot("/screenshots/model-outputs-balance-ch6-magnet-off.png")
simulator.pressKey(KEY_RTN) -- cancel
...
simulator.screenshot("/screenshots/model-outputs-balance-ch6-magnet-on.png")

simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.screenshot("/screenshots/model-outputs-balance-curve-edit.png")
...
simulator.screenshot("/screenshots/model-outputs-balance-ch2-9-8-1.png")
simulator.pressKey(KEY_RTN, 0.6)
...
--simulator.screenshot("/screenshots/model-outputs-balance-ch2-9-1-8.png")
simulator.screenshot("/screenshots/model-outputs-balance-ch2-9-8-1.png")
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN)
