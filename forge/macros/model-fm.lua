...
simulator.screenshot("/screenshots/model-icon-fm.png")
simulator.pressKey(KEY_ENTER) -- open
simulator.screenshot("/screenshots/model-fm.png")
--[[
...
simulator.screenshot("/screenshots/model-fm-form.png")
...
simulator.screenshot("/screenshots/model-fm-0to3.png")
simulator.pressKey(KEY_ENTER) -- open options menu
--simulator.turnRotaryEncoder(3)
simulator.turnRotaryEncoder(2) -- scroll to move
simulator.screenshot("/screenshots/model-fm-move-select.png")
simulator.pressKey(KEY_ENTER) -- y
simulator.screenshot("/screenshots/model-fm-move.png")
simulator.pressKey(KEY_RTN) -- deselect
...
simulator.screenshot("/screenshots/tut-fw-eg-trims-ele-add-behavior.png")
simulator.pressKey(KEY_ENTER)
...
simulator.screenshot("/screenshots/tut-fw-eg-trims-ele-custom-default-plus-offset-select.png")
simulator.pressKey(KEY_ENTER)-- y
simulator.turnRotaryEncoder(1) -- scroll to add new behavior
simulator.screenshot("/screenshots/tut-fw-eg-trims-ele-custom-default-plus-offset-fm1.png")
simulator.pressKey(KEY_ENTER) -- y
simulator.turnRotaryEncoder(-1) -- back to active cond
simulator.pressKey(KEY_ENTER) -- y
--[[
...
simulator.pressKey(KEY_ENTER) -- y
simulator.turnRotaryEncoder(2) -- scroll to Offset plus Default
--simulator.screenshot("/screenshots/tut-fw-eg-trims-ele-custom-default-plus-offset-fm2-select.png")
simulator.pressKey(KEY_ENTER) -- y
simulator.screenshot("/screenshots/tut-fw-eg-trims-ele-custom-default-plus-offset-fm2.png")
simulator.pressKey(KEY_RTN)
simulator.pressKey(KEY_RTN, 1)
