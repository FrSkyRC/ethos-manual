...
- **[Manches](../system-setup/controls.md)** :
  ...
  - **Ordre des voies** : l'ordre des voies par défaut pour Ethos est **AETR**
    ...
    !!! note "Récepteurs stabilisés FrSky"
        ...
        modèles comportant plus d'une surface par fonction, l'assistant regroupe
        normalement ces surfaces, de sorte que vous obtenez **AAETR**, alors que
        les récepteurs SRx attendent plutôt l'ordre **AETRA**/**AETRAE**. Activez
        donc **[Quatre
        premières voies
