...
![Texte de liste de contrôle utilisateur](../screenshots/model-checklist-user-checklist.png)
...
format Markdown, affiché automatiquement à chaque fois que ce modèle est chargé.
